...
### Walkthrough Video
![](https://github.com/KevinGomes/lifetracker-starter/blob/main/walkthrough_student_store_00.gif)
![](https://github.com/KevinGomes/lifetracker-starter/blob/main/walkthrough_student_store_01.gif)
...
The weekly labs were extremely helpful in completling the assignment in paticular the vaccine hub lab was helpful in understanding how backend calls should be initiated. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I focused entitrely too much on debugging my css, which caused me to sacrifice functionality. To aviod this I plan on work on the backend of a project befire commiting to the front end.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

My demo went well enough, I wished for my backend to be completely connected, but could not do so due to a syntax error. The overseeing mentor reccomended using perttier and litner for vscode to avoid such issues in the future.
